...
class OAK_Substage(Stage, ABC):
    def __init__(self, configs, name="", color_input_size = [0,0], left_input_size = [0,0], right_input_size = [0,0], uses_depth = False):
        super(Stage, self).__init__(configs=configs)
    ...
    def link(self, rgb_out, left_out, right_out, depth_out):
        return {}
