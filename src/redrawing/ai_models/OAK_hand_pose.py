...
import redrawing.ai_models.third_models.oak_hand_tracker as oak_hand_tracker
from redrawing.ai_models.third_models.oak_hand_tracker.HandTracker import HandTracker, to_planar
import redrawing.ai_models.third_models.oak_hand_tracker.mediapipe_utils as mpu
...
class OAK_Handpose(OAK_Substage):
    ...
    def create_nodes(self, pipeline):
        base_path = os.path.abspath(oak_hand_tracker.__file__)
