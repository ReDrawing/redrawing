...
import redrawing.ai_models.third_models.oak_blazepose as oak_blazepose
from redrawing.ai_models.third_models.oak_blazepose.BlazeposeDepthai import BlazeposeDepthai, to_planar
import redrawing.ai_models.third_models.oak_blazepose.mediapipe_utils as mpu
...
class OAK_Blazepose(OAK_Substage):
    ...
    def create_nodes(self, pipeline):
        base_path = os.path.abspath(oak_blazepose.__file__)
